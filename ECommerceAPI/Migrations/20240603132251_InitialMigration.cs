    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CategoryAttributesId = table.Column<long>(type: "bigint", nullable: false),
                    categoriesId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryCategoryAttribute", x => new { x.CategoryAttributesId, x.categoriesId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryCategoryAttribute_CategoryAttributes_CategoryAttributesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CategoryAttributeValues_CategoryAttributes_ProductAttributeId",
                        column: x => x.ProductAttributeId,
                        principalTable: "CategoryAttributes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryAttributeValues_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecurityCode = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryAttributeValues_ProductAttributeId",
                table: "CategoryAttributeValues",
                column: "ProductAttributeId");

            migrationBuilder.CreateIndex(
                name: "IX_CategoryAttributeValues_ProductId",
                table: "CategoryAttributeValues",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_CategoryCategoryAttribute_categoriesId",
